...
class Larg_logado extends StatefulWidget {
  Larg_logado({Key? key}) : super(key: key);

  @override
  State<Larg_logado> createState() => _Larg_logadoState();
}

class _Larg_logadoState extends State<Larg_logado> {
